...
public struct ChartForm {
    ...
    public static let extraLarge = CGSize(width: UIScreen.isSmallScreen ? 300 : UIScreen.screenWidth * 0.9, height: UIScreen.isSmallScreen ? 250 : 300)
...
public class TestData{
    ...
    static public var values:ChartData = ChartData(values: [("2017 Q3",2),
                                                            ("2017 Q4",15),
                                                            ("2018 Q1",81),
                                                            ("2018 Q2",184),
                                                            ("2018 Q3",558),
